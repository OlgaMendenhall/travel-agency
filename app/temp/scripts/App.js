...
/***/ function(module, exports, __webpack_require__) {
	...
	var mobileMenu = new _MobileMenu2.default(); // here we're saying that mobileMenu is a new instance of the MobileMenu class
...
/***/ function(module, exports, __webpack_require__) {
	...
	// import jQuery from the jQuery npm package
				...
				this.itemsToReveal.each(function () {
					...
					new Waypoint({
						...
						handler: function handler() {
							// this is what we want to happen when that element is scrolled to
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
		function StickyHeader() {
			...
			this.pageSections = (0, _jquery2.default)(".page-section"); // this property is a collection of our page section elements
			this.headerLinks = (0, _jquery2.default)(".primary-nav a"); // collection of all our header links
		...
		_createClass(StickyHeader, [{
			...
			value: function createPageSectionWaypoints() {
				// making Links to Highlight Current Page Section
				var that = this;
				this.pageSections.each(function () {
					// here we're looping through the collection
	...
	var Modal = function () {
		...
		_createClass(Modal, [{
			...
			value: function keyPressHandler(e) {
				if (e.keyCode == 27) {
					// if a user pushes the escape key, which value is 27 
					this.closeModal(); // then the modal window will be closed
				}
			}
		}, {
			key: "openModal",
			value: function openModal() {
				...
				return false; // prevents the default behavior of scrolling up to the website top when we push the button
			}
		}, {
			key: "closeModal",
